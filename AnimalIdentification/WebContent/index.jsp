...
<body>
	...
	<div class="" id="addrule" style="display:none;">
		<form id="addrule_par" action="">
				...
				<label>特征：</label><input style="width:300px;padding-left:20px" type="text" name="conditions" id="" value="" />
				</div>
				<div style="padding-left:20px">
				<label>结果：</label><input style="width:300px;padding-left:20px" type="text" name="result" id="" value="" />
				</div>
	...
	<div id="deleterule" style="display:none;">
		<div style="overflow:scroll;" id="features">
								<%
								ArrayList<RuleVO> rules = (ArrayList<RuleVO>)request.getAttribute("rules");
								//ArrayList<String> rules = (ArrayList<String>)request.getAttribute("rules"); %>
								<%
								for(RuleVO rule:rules){
									if(rule!=null){
										
									String rule_beshow = rule.conditionstr+"=>"+rule.result;
								%>
									<div class="rule_beshow">
										<input name="rule_beshow" type="checkbox" value=<%=rule.id%> class="delete_row"><%=rule_beshow%> 
									</div>
								<%
									}
								}
				...
				$("#addrule_btn").click(function() {
					layer.open({
						...
						yes: function(index, layero){
							//alert("click");
							var conditions_obj = document.getElementsByName("conditions");
							var result_obj = document.getElementsByName("result");
